...
const FetchDataContextStorage = React.createContext(fetchDataContextStorageDefaultValues);
const FetchDataContextStorageWrapper = ({ children }) => {
    ...
    return (React.createElement(FetchDataContextStorage.Provider, { value: contextValue },
        React.createElement(InitialHooksWrapper, null, children)));
};
...
export { FetchDataContextStorage, FetchDataContextStorageWrapper, useCatalogs, useCatalogsWithContext, useFetchContext };
